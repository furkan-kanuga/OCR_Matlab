...
%**********************************
conc=strel('disk',1);
gi=imdilate(g,conc);        %%bolds image
ge=imerode(g,conc);            %%remove thin lns
gdiff=imsubtract(gi,ge);    %%edge enhancmaent
gdiff=mat2gray(gdiff);      
gdiff=conv2(gdiff,[1 1;1 1]);       %%automatically crp numberplate
